...
$wp_customize->add_section( 'cakecious_section_header_alt_colors', array(
	'title'       => esc_html__( 'Alternate Header Colors', 'cakecious-features' ),
	'description' => '<p>' . esc_html__( 'Additional header color scheme that could be applied to specific pages.', 'cakecious-features' ) . '</p><p>' . esc_html__( 'For example, Page-A uses light-colored header, while Page-B uses dark-colored header.', 'cakecious-features' ) . '</p>' . $switcher,
	'panel'       => $panel,
	'priority'    => 43,
) );