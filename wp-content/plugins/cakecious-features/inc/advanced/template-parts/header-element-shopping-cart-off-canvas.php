...
<div class="<?php echo esc_attr( 'cakecious-header-' . $slug ); ?> cakecious-header-shopping-cart menu <?php echo esc_html($is_dropdown) ? esc_attr( 'cakecious-toggle-menu' ) : ''; ?>">
	<div class="menu-item">
		<?php if ( $is_dropdown ) : ?>
			<button class="shopping-cart-link cakecious-menu-item-link cakecious-popup-toggle cakecious-toggle" data-target="off-canvas-cart" aria-expanded="false">
		<?php else: ?>
			<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="shopping-cart-link cakecious-menu-item-link">
		<?php endif; ?>
				<span class="screen-reader-text"><?php esc_html_e( 'Shopping Cart', 'cakecious-features' ); ?></span>
