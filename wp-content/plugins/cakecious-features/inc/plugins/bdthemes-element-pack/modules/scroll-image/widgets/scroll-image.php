	...
	protected function render_image($settings) {
		...
		if ( $settings['image_framing'] ) : ?>
			<div class="bdt-device-slider-device">
				<img src="<?php echo BDTEP_ASSETS_URL; ?>images/devices/<?php echo esc_attr( $frame ); ?>.svg" alt="image">
			...
			<div <# print(container_print); #>>
				...
				<# } #>
					...
					<# } #>
						...
						<# if ( settings.image_framing ) { #>
							<div class="bdt-device-slider-device">
								<img src="<?php echo esc_url(BDTEP_ASSETS_URL); ?>images/devices/{{{frame}}}.svg" alt="image">
