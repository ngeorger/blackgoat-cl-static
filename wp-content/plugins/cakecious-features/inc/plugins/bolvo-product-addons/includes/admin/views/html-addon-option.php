...
?>
<div class="blv-cust-p-addon-option-row">
	<span class="blv-cust-p-addon-sort-handle dashicons dashicons-menu"></span>
	<div class="blv-cust-p-addon-content-image <?php echo esc_attr( $opt_display_image ); ?>">
		<span class="dashicons dashicons-format-image blv-cust-p-addon-add-image <?php echo esc_attr( $opt_show_add_image ); ?>">
			<input type="hidden" name="product_addon_option_image[<?php echo $loop; ?>][]" value="<?php echo esc_attr( $opt_image ); ?>" class="blv-cust-p-addon-option-image-id" />
		</span>
		<span class="dashicons dashicons-plus <?php echo esc_attr( $opt_show_add_image ); ?>"></span>
		<a href="#" class="blv-cust-p-addon-image-swatch <?php echo esc_attr( $opt_show_image_swatch ); ?>"><?php echo $opt_image_thumb; ?><span class="dashicons dashicons-dismiss"></span></a>
	</div>
	
	<div class="blv-cust-p-addon-content-label <?php echo esc_attr( $opt_label_column ); ?>">
	...
	<div class="blv-cust-p-addon-content-price-type">
		<select name="product_addon_option_price_type[<?php echo $loop; ?>][]" class="blv-cust-p-addon-option-price-type">
	...
	<div class="blv-cust-p-addon-content-price">
	...
	<div class="blv-cust-p-addon-content-remove">
		<button type="button" class="blv-cust-p-remove-option button">x</button>
	</div>
</div>
