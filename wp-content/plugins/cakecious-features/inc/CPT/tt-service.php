...
function tt_service_module_cpt() {
	...
	if( function_exists( 'tt_temptt_get_option' ) ) {
		...
		$service_cpt_slug = tt_temptt_get_option( 'service_cpt_slug', 'service-item' );
		$service_cpt_cat_slug = tt_temptt_get_option( 'service_cpt_cat_slug', 'service-cats' );
		$service_cpt_single = tt_temptt_get_option( 'service_cpt_single', true );
	}
	// With Front
	...
	$cpt_args = array(
		'labels' => array(
			'name' => esc_attr__( 'Service', 'cakecious' ),
			'singular_name' => esc_attr__( 'Service', 'cakecious' ),
			'add_new' => esc_attr__( 'Add Service', 'cakecious' ),
			'add_new_item' => esc_attr__( 'Add Service', 'cakecious' ),
			'edit' => esc_attr__( 'Edit', 'cakecious' ),
			'edit_item' => esc_attr__( 'Edit Service', 'cakecious' ),
			'new_item' => esc_attr__( 'New Service', 'cakecious' ),
			'view' => esc_attr__( 'View Service', 'cakecious' ),
			'view_item' => esc_attr__( 'View Service', 'cakecious' ),
			'search_items' => esc_attr__( 'Search Service', 'cakecious' ),
			'not_found' => esc_attr__( 'No Service found', 'cakecious' ),
			'not_found_in_trash' => esc_attr__( 'No Service found in Trash', 'cakecious' ),
			'parent' => esc_attr__( 'Parent Service', 'cakecious' ),
		),
		'public' => true,
	...
	$tax_args = array(
		'labels' => array(
			'name' => esc_attr__( 'Service Categories', 'cakecious' ),
