...
?>
<div class="<?php echo esc_attr( 'cakecious-header-' . $slug ); ?> cakecious-header-shopping-cart menu <?php echo esc_html($is_dropdown) ? esc_attr( 'cakecious-toggle-menu' ) : ''; ?>">
	<div class="menu-item">
		<?php if ( $is_dropdown ) : ?>
			<button class="shopping-cart-link cakecious-menu-item-link cakecious-sub-menu-toggle cakecious-toggle" aria-expanded="false">
		<?php else: ?>
		...
		<?php if ( $is_dropdown ) : ?>
			<div class="sub-menu"><?php echo do_shortcode($dropdown_html); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
		<?php endif; ?>
	</div>
</div>