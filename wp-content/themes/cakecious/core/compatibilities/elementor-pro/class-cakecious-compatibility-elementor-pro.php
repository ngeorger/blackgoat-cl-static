...
class Cakecious_Compatibility_Elementor_Pro {

	/**
	 * Singleton instance
	 *
	 * @var Cakecious_Compatibility_Elementor_Pro
	 */
	 ...
	 *
	 * @return Cakecious_Compatibility_Elementor_Pro
	 */
	...
	public function add_compatibility_css() {
		$css = "\n/* Elementor Pro Compatibility CSS */\n" . cakecious_minify_css_string( '.elementor .elementor-wc-products .woocommerce ul.products li.product { width: auto; }' );
	...
	public function register_elementor_locations( $elementor_theme_manager ) {
		...
		foreach ( array( 'header', 'footer' ) as $location ) {
			$hook = 'cakecious/frontend/' . $location;
			$hook_object = cakecious_array_value( $wp_filter, $hook );
...
Cakecious_Compatibility_Elementor_Pro::instance();