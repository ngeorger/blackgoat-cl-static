...
class Cakecious_Compatibility_Jetpack {

	/**
	 * Singleton instance
	 *
	 * @var Cakecious_Compatibility_Jetpack
	 */
	 ...
	 *
	 * @return Cakecious_Compatibility_Jetpack
	 */
	...
	protected function __construct() {
		...
		add_action( 'cakecious/frontend/before_enqueue_main_css', array( $this, 'enqueue_css' ) );
	}
	...
	public function enqueue_css() {
		wp_enqueue_style( 'cakecious-jetpack', CAKECIOUS_CSS_URL . '/compatibilities/jetpack/jetpack' . CAKECIOUS_ASSETS_SUFFIX . '.css', array(), CAKECIOUS_VERSION );
		wp_style_add_data( 'cakecious-jetpack', 'rtl', 'replace' );
	}
...
Cakecious_Compatibility_Jetpack::instance();