...
$section = 'cakecious_section_entry_grid';
...
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_entry_grid_item', array(
	'section'     => $section,
	'settings'    => array(),
...
$wp_customize->add_control( new Cakecious_Customize_Control_Toggle( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Same height items in a row', 'cakecious' ),
	'priority'    => 20,
) ) );
...
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_entry_grid_header', array(
	'section'     => $section,
	'settings'    => array(),
...
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_entry_grid_thumbnail', array(
	'section'     => $section,
	'settings'    => array(),
...
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_entry_grid_content', array(
	'section'     => $section,
	'settings'    => array(),
...
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_entry_grid_meta', array(
	'section'     => $section,
	'settings'    => array(),
...
// Heading: Colors
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_entry_grid_colors', array(
	'section'     => $section,
	'settings'    => array(),
...
// Colors
$colors = array(
	'entry_grid_bg_color'     => esc_html__( 'Background color', 'cakecious' ),
	'entry_grid_border_color' => esc_html__( 'Border color', 'cakecious' ),
);
