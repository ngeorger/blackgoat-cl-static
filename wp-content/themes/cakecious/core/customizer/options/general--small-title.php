...
$section = 'cakecious_section_small_title';
...
$wp_customize->add_control( new Cakecious_Customize_Control_Typography( $wp_customize, 'small_title_typography', array(
	'settings'    => $settings,
	'section'     => $section,
	'label'       => esc_html__( 'Small Title typography', 'cakecious' ),
	'priority'    => 10,
) ) );

// ------
$wp_customize->add_control( new Cakecious_Customize_Control_HR( $wp_customize, 'hr_small_title_colors', array(
	'section'     => $section,
	'settings'    => array(),
	'priority'    => 10,
) ) );
...
// Colors
$colors = array(
	'small_title_text_color'       => esc_html__( 'Small Title text color', 'cakecious' ),
	'small_title_hover_text_color' => esc_html__( 'Small Title link text color :hover', 'cakecious' ),
);
