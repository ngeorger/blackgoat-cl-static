...
$section = 'cakecious_section_header_social';
...
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_header_social', array(
	'section'     => $section,
	'settings'    => array(),
...
if ( isset( $wp_customize->selective_refresh ) ) {
	$wp_customize->selective_refresh->add_partial( $key, array(
		'selector'            => '.cakecious-header-social',
		'container_inclusive' => true,
		'render_callback'     => function() {
			cakecious_header_element( 'social' );
		},
