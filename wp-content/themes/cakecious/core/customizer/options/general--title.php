...
$section = 'cakecious_section_title';
...
$wp_customize->add_control( new Cakecious_Customize_Control_Typography( $wp_customize, 'title_typography', array(
	'settings'    => $settings,
	'section'     => $section,
...
// ------
$wp_customize->add_control( new Cakecious_Customize_Control_HR( $wp_customize, 'hr_title_colors', array(
	'section'     => $section,
	'settings'    => array(),
	'priority'    => 10,
) ) );
...
// Colors
$colors = array(
	'title_text_color'       => esc_html__( 'Title text color', 'cakecious' ),
	'title_hover_text_color' => esc_html__( 'Title link text color :hover', 'cakecious' ),
);
