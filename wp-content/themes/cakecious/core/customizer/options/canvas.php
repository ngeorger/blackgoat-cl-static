...
$section = 'cakecious_section_page_canvas';
...
$wp_customize->add_control( new Cakecious_Customize_Control_RadioImage( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Page layout', 'cakecious' ),
	'choices'     => array(
		'full-width' => array(
			'label' => esc_html__( 'Full width', 'cakecious' ),
			'image' => CAKECIOUS_IMAGES_URL . '/customizer/page-layout--full-width.svg',
		),
		'boxed'      => array(
			'label' => esc_html__( 'Boxed', 'cakecious' ),
			'image' => CAKECIOUS_IMAGES_URL . '/customizer/page-layout--boxed.svg',
		),
	),
	'priority'    => 10,
) ) );
...
$wp_customize->add_control( new Cakecious_Customize_Control_Color( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Page background color', 'cakecious' ),
	'priority'    => 10,
) ) );

// ------
$wp_customize->add_control( new Cakecious_Customize_Control_HR( $wp_customize, 'hr_container_width', array(
	'section'     => $section,
	'settings'    => array(),
	'priority'    => 20,
) ) );
...
$wp_customize->add_control( new Cakecious_Customize_Control_Slider( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Normal container width', 'cakecious' ),
	'units'       => array(
		'px' => array(
			'min'  => 600,
			'max'  => 1600,
...
$wp_customize->add_control( new Cakecious_Customize_Control_Slider( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Narrow container width', 'cakecious' ),
	'description' => esc_html__( 'Used when "Narrow" content layout is enabled on the page. This value should be smaller than the "Normal" container width.', 'cakecious' ),
	'units'       => array(
		'px' => array(
			'min'  => 600,
			'max'  => 1000,
...
// Heading: Boxed Page
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_boxed_page', array(
	'section'     => $section,
	'settings'    => array(),
	'label'       => esc_html__( 'Boxed Page', 'cakecious' ),
	'priority'    => 30,
) ) );
...
$wp_customize->add_control( new Cakecious_Customize_Control_Slider( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Boxed page max width', 'cakecious' ),
	'units'       => array(
		'px' => array(
			'min'  => 500,
			'max'  => 2000,
...
$wp_customize->add_control( new Cakecious_Customize_Control_Shadow( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Boxed page shadow', 'cakecious' ),
	'priority'    => 30,
) ) );

// ------
$wp_customize->add_control( new Cakecious_Customize_Control_HR( $wp_customize, 'hr_boxed_page_outside', array(
	'section'     => $section,
	'settings'    => array(),
	'priority'    => 30,
) ) );
...
$wp_customize->add_control( new Cakecious_Customize_Control_Color( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Outside background color', 'cakecious' ),
	'priority'    => 30,
) ) );
...
$wp_customize->add_control( new Cakecious_Customize_Control_Background( $wp_customize, $key, array(
	'settings'    => $settings,
	'section'     => $section,
	'label'       => esc_html__( 'Outside background image', 'cakecious' ),
	'priority'    => 30,
) ) );