...
$section = 'cakecious_section_blockquote';
...
$wp_customize->add_control( new Cakecious_Customize_Control_Typography( $wp_customize, 'blockquote_typography', array(
	'settings'    => $settings,
	'section'     => $section,
	'label'       => esc_html__( 'Blockquote typography', 'cakecious' ),
	'priority'    => 10,
) ) );