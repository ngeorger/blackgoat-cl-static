...
$section = 'cakecious_section_footer_bottom_bar';
...
$wp_customize->add_control( new Cakecious_Customize_Control_Toggle( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Merge inside Widgets Bar wrapper', 'cakecious' ),
	'priority'    => 10,
) ) );
...
$wp_customize->add_control( new Cakecious_Customize_Control_Dimension( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Gap with Widgets Bar content', 'cakecious' ),
	'units'       => array(
		'px' => array(
			'min'   => 0,
			'step'  => 1,
...
// ------
$wp_customize->add_control( new Cakecious_Customize_Control_HR( $wp_customize, 'hr_footer_bottom_bar_merged', array(
	'section'     => $section,
	'settings'    => array(),
	'priority'    => 10,
) ) );
...
// Heading: Typography
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_footer_bottom_bar_typography', array(
	'section'     => $section,
	'settings'    => array(),
...
$wp_customize->add_control( new Cakecious_Customize_Control_Typography( $wp_customize, 'footer_bottom_bar_typography', array(
	'settings'    => $settings,
	'section'     => $section,
...
// Heading: Colors
$wp_customize->add_control( new Cakecious_Customize_Control_Heading( $wp_customize, 'heading_footer_bottom_bar_colors', array(
	'section'     => $section,
	'settings'    => array(),
...
// Colors
$colors = array(
	'footer_bottom_bar_bg_color'              => esc_html__( 'Background color', 'cakecious' ),
	'footer_bottom_bar_border_color'          => esc_html__( 'Border color', 'cakecious' ),
	'footer_bottom_bar_text_color'            => esc_html__( 'Text color', 'cakecious' ),
	'footer_bottom_bar_link_text_color'       => esc_html__( 'Link text color', 'cakecious' ),
	'footer_bottom_bar_link_hover_text_color' => esc_html__( 'Link text color :hover', 'cakecious' ),
);
