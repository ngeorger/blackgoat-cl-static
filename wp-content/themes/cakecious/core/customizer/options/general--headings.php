...
$section = 'cakecious_section_headings';
...
for ( $i = 1; $i <= 4; $i++ ) {
	...
	$wp_customize->add_control( new Cakecious_Customize_Control_Typography( $wp_customize, 'h' . $i . '_typography', array(
		'settings'    => $settings,
		'section'     => $section,
		/* translators: %1$s: heading level number. */
		'label'       => sprintf( esc_html__( 'Heading %1$s (H%1$s) typography', 'cakecious' ), $i ),
		'priority'    => 10,
	) ) );
}

// ------
$wp_customize->add_control( new Cakecious_Customize_Control_HR( $wp_customize, 'hr_headings_colors', array(
	'section'     => $section,
	'settings'    => array(),
	'priority'    => 10,
) ) );
...
// Colors
$colors = array(
	'heading_text_color'       => esc_html__( 'Heading text color', 'cakecious' ),
	'heading_hover_text_color' => esc_html__( 'Heading link text color :hover', 'cakecious' ),
);
